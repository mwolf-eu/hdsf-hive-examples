...
H.Namespace.set(H, 'ccnetvis.spectral');
H.ccnetvis.spectral = function() {
 
const create2dArray = H.ccnetvis.layout_utils.create2dArray;
...
class Spectral {
  ...
  apply() {
    ...
    for (let i = 0; i < this._edges.length; ++i) {
      ...
      //let ii = this._edges[i].source;
      //let j = this._edges[i].target;
